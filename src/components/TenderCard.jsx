...
const TenderCard = () => {
  return (
    ...
    <div className="card-body text-gray-600">
      <h2 className="card-title text-gray-600">Dummy Title: Sample Tender</h2>
      <div className="divider -my-1"></div>
      <p> <span className='font-bold'>Bid Closing Date : </span>2023-12-31</p>
      <p><span className='font-bold'> Bid Opening Date : </span>2023-12-01</p>
      <p><span className='font-bold'>Published On : </span>2023-11-01</p>
